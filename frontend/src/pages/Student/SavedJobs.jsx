        ...
        {getJobs.length === 0 ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {getJobs.map((saved) => (
              ...
              >
                <button
                  className="absolute top-4 right-4 flex items-center text-red-500 hover:text-red-600 text-sm font-medium"
                ...
                <div className="mt-auto flex flex-col sm:flex-row gap-2">
                  <Link to={`/jobdetail/${saved.job._id}`} className="flex-1">
                    <button className="w-full px-4 py-2 text-sm rounded-lg bg-gray-100 hover:bg-gray-200">
                      View Details
                    </button>
                  </Link>
                  <button
                    onClick={() => applyJob(saved.job._id)}
                    className="flex-1 px-4 py-2 text-sm rounded-lg bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center"
                  >
