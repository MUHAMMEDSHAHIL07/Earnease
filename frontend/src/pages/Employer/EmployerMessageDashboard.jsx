          ...
          const mapped = res.data.chatRooms.map((room) => ({
            ...
            student: {
              ...
              avatar: room.student.avatarUrl ? (
                <img src={room.student.avatarUrl} alt={room.student.name} className="w-12 h-12 rounded-full object-cover" />
    ...
    <div className="h-screen bg-gray-50 flex">
      <div className="w-[30%] bg-white border-r border-gray-200 flex flex-col">
        <div className="p-4 border-b border-gray-200 bg-blue-600">
          <h2 className="text-white font-semibold text-lg">Student Messages</h2>
        ...
        <div className="flex-1 overflow-y-auto">
          {conversations.map((chat) => (
            <div
              key={chat.id}
              onClick={() => navigate(`/employer/inbox/${chat.id}`)}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start">
                    <h3 className="font-semibold text-gray-900 text-sm truncate">{chat.student.name}</h3>
