  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div
          className={`w-full lg:w-[380px] bg-white border-r border-gray-200 flex flex-col ${
          ...
          {chatRoomId ? (
            ...
            <div className="flex-1 flex items-center justify-center bg-gray-50">
              <div className="text-center">
                ...
                <p className="text-gray-500 max-w-sm">Choose from your existing conversations or start a new one</p>
              </div>
            </div>
          )}
        </div>
